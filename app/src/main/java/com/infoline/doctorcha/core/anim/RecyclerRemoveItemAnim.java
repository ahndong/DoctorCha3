package com.infoline.doctorcha.core.anim;

/**
 * Created by DELL on 2016-02-19.
 */
...
public class RecyclerRemoveItemAnim extends SimpleItemAnimator {
        ...
        if (!mPendingRemove.isEmpty()) {
            for (final RecyclerView.ViewHolder viewHolder : mPendingRemove) {
                ...
                animator.playTogether(
                        ...
                        ObjectAnimator.ofFloat(target, "translationY", 0.0f, -target.getMeasuredHeight())
                );
    ...
    public boolean animateRemove(RecyclerView.ViewHolder viewHolder) {
        return mPendingRemove.add(viewHolder);
        //return false;
    }
